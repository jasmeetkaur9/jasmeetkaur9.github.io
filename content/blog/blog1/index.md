...
I code everything using PyTorch. I think PyTorch is amazing. My first baseline paper had code written in TensorFlow, and I sort of caught up with PyTorch by writing all that TensorFlow code using PyTorch. 'Twas a good exercise. It’s well-documented with a helpful community—I have been able to find all the answers to my queries on their blog.
